...
public class MFAUserInfo {
    ...
    private static final List<String> oldMethods = List.of("fido2", "super_gluu", "otp", "twilio_sms");
    ...
    public String getPreference() {
        ...
        if (preference == null || !oldMethods.contains(preference)) return preference;
        
        return "io.jans.casa.authn." + preference;
